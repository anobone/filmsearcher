...
<main style="background-color: rgba(77,102,171,0.63);">
    <div class="background">
        ...
        <div style="padding-left: 20px; margin-bottom: 10px;">
            ...
            while($row = $query->fetch_assoc()){
                $idname= $row['name'];}
            echo "<h1 style='font-family: SansSerif;border-bottom: 3px solid rgba(0,0,0,0.45);color:rgba(0,0,0,0.58);'><b>$idname</b></h1>";
            ?>
        </div>
        <?
